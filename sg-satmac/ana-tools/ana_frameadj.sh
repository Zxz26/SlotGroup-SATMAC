...
gawk -v node_count=1400 -f lpf.awk SATMAC/T0.3E0.5/log_lpf_n1400.txt
gawk -v node_count=1600 -f lpf.awk SATMAC/T0.3E0.5/log_lpf_n1600.txt
...
gawk -v node_count=1400 -f lpf.awk SATMAC/T0.4E0.5/log_lpf_n1400.txt
gawk -v node_count=1600 -f lpf.awk SATMAC/T0.4E0.5/log_lpf_n1600.txt
...
gawk -v node_count=1400 -f lpf.awk SATMAC/T0.4E0.6/log_lpf_n1400.txt
gawk -v node_count=1600 -f lpf.awk SATMAC/T0.4E0.6/log_lpf_n1600.txt
