...
LteSpectrumPhy::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::LteSpectrumPhy")
	...
	.AddTraceSource ("RbCollisionTrace",
					 "Trace fired when DropRbOnCollision happened",
					 MakeTraceSourceAccessor (&LteSpectrumPhy::m_phyRbCollisionTrace),
					 "ns3::LteSpectrumPhy::RbCollisionTracedCallback")
